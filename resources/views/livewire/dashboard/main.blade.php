<div class="py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 md:col-span-2">
                @php
                    ...
                    if ($collectionHealth >= 100) {
                        ...
                        $barColor = 'bg-yellow-500'; // Amarillo
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl shadow lg:col-span-2 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center">
                    <h3 class="font-bold text-gray-800">🚨 Clientes en Mora (Prioridad)</h3>
                    <a href="{{ route('credits.index') }}" class="text-xs text-blue-600 hover:underline">Ver todos</a>
                </div>
                            ...
                            @forelse($lateInstallments as $installment)
                                <tr class="bg-white border-b hover:bg-gray-50">
                                    <td class="px-6 py-4 font-medium text-gray-900">
                                        ...
                                        <div class="text-xs text-gray-500">Crédito #{{ $installment->credit_id }}</div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <span class="text-red-600 font-bold">
                                            {{ \Carbon\Carbon::parse($installment->due_date)->format('d/m') }}
                                        </span>
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('clients.history', $installment->credit->client_id) }}"
                                            class="text-white bg-indigo-600 hover:bg-indigo-700 font-medium rounded-lg text-xs px-3 py-2 text-center inline-flex items-center">
                                            Gestionar
                                        </a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="4" class="px-6 py-8 text-center text-gray-500">
                                        🎉 ¡Excelente! No hay cuotas vencidas pendientes.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
