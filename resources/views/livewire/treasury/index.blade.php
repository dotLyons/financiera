<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <h3 class="text-lg font-medium text-gray-900 mb-4 px-1">Saldos por Cobrador</h3>
            ...
            @foreach ($collectors as $collector)
                <div
                    ...
                    <div class="bg-gray-50 px-6 py-4 border-t border-gray-100 space-y-2">
                        ...
                        @else
                            <button disabled
                                class="w-full inline-flex justify-center items-center px-4 py-2 bg-gray-300 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest cursor-not-allowed">
                                Sin saldo a rendir
                            </button>
                        @endif
