            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @elseif (auth()->user()->role === 'collector')
                        ...
                        <x-nav-link href="{{ route('collector.my-cash') }}" :active="request()->routeIs('collector.my-cash')">
                            {{ __('Mi Caja') }}
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if (auth()->user()->role === 'admin')
                ...
                <x-responsive-nav-link href="{{ route('credits.index') }}" :active="request()->routeIs('credits.index')">
                    {{ __('Créditos') }}
                </x-responsive-nav-link>
            ...
            @elseif (auth()->user()->role === 'collector')
                ...
                <x-responsive-nav-link href="{{ route('collector.my-cash') }}" :active="request()->routeIs('collector.my-cash')">
                    {{ __('Mi Caja') }}
                </x-responsive-nav-link>
            @endif
        </div>
